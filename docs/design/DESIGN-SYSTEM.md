...
**Código:** OT-SEM-DESIGN-001 · **Gobernanza:** OT-BRANDING-005  
**Versión:** v1.0 (Experience Kit)

> **Punto de entrada:** [INTRODUCTION.md](./INTRODUCTION.md) — documentación completa del Experience Kit.  
> **Identidad editorial:** [EDITORIAL-ART-DIRECTION.md](./EDITORIAL-ART-DIRECTION.md) — cómo debe comunicarse visualmente el SEM.
...
├── styles/
│   └── tokens/
│       ├── brand.css    # 5 colores SEM (--sem-*)
│       └── colors.css   # alias, grises, estados UI
...
└── app/
    ...
    └── internal/design-system/  # Catálogo visual (OT-BRANDING-005)
```
...
> **Sistema corporativo de marca (OT-BRANDING-002):** ver [BRANDING-SYSTEM.md](./BRANDING-SYSTEM.md) para la fuente única de tokens `--sem-*`, alias, escala neutra y reglas de validación CI.
...
- Consultar el catálogo en `/internal/design-system`
...
Visita **`/internal/design-system`** para ver todos los componentes en contexto, incluyendo:
