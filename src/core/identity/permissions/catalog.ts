...
export const PERMISSION_MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        code: "growth.campaigns.view",
        label: "Ver campañas",
        description: "Ver campañas, detalle y métricas del Espacio",
        module: "growth",
        impliesLegacy: ["growth.campaigns.view"],
      },
      {
        code: "growth.campaigns.manage",
        label: "Gestionar campañas",
        description: "Crear, editar, activar y terminar campañas",
        module: "growth",
        impliesLegacy: ["growth.campaigns.manage"],
      },
      {
        code: "growth.analytics.view",
        label: "Ver Analítica del Espacio",
        description: "Ver totales y desgloses de Analítica V1 del Espacio",
        module: "growth",
        impliesLegacy: ["growth.analytics.view"],
      },
      {
        code: "growth.people.view",
        label: "Ver Personas",
        description: "Ver listado y ficha de Personas del Espacio",
        module: "growth",
        impliesLegacy: ["growth.people.view"],
      },
      {
        code: "growth.people.manage",
        label: "Gestionar Personas",
        description: "Crear Personas manualmente en el Espacio",
        module: "growth",
        impliesLegacy: ["growth.people.manage"],
      },
    ],
  },
  {
