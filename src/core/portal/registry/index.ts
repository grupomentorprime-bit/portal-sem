...
export const PORTAL_BLOCK_REGISTRY: PortalBlockDefinition[] = [
  ...
  { type: "teachers", version: 1, name: "Equipo", category: "Académico", component: "TeachersSection", resolver: "team", queryDriven: true },
  { type: "news", version: 1, name: "Noticias", category: "Contenido", component: "NewsBlockSection", resolver: "news", queryDriven: true },
  ...
  { type: "cta", version: 1, name: "CTA", category: "Conversión", component: "CtaBlockSection" },
