import { AutomatizacionesListClient } from "@/components/admin/growth/AutomatizacionesListClient";
...
export default async function AdminAutomatizacionesPage() {
  ...
  const items = await listAutomationViews(tenantId);

  return (
    <AutomatizacionesListClient items={items} canManage={canManage} />
  );
}
